...
#pragma warning restore 612, 618
    ...
    public class DrvCSScanner : DriverScanner<SparkplugBND>
    {
        ...
        public void ProcessPointData(PointSourceEntry FoundPoint, Payload.Types.Metric r)
        {
			...
			{
				case 1: // Int8
					value = (sbyte)(int)r.IntValue;
					break;
				case 2: // Int16
					value = (short)(int)r.IntValue;
					break;
				case 3: // Int32
					value = (int)r.IntValue;
					break;
				case 4: // Int64
					value = (long)r.LongValue;
					break;
				case 5: // UInt8
					value = (byte)r.IntValue;
					break;
				case 6: // UInt16
					value = (ushort)r.IntValue;
					break;
				case 7: // UInt32
					if (r.ValueCase == Payload.Types.Metric.ValueOneofCase.LongValue)
					{
						value = (uint)r.LongValue;
					}
					else
					{
						value = r.IntValue;
				...
				case 15: // UUID
					...
					break;
				case 13: // DateTime
					value = DateTime.Parse("01/Jan/1970").AddMilliseconds(r.LongValue);
					break;
				default:
